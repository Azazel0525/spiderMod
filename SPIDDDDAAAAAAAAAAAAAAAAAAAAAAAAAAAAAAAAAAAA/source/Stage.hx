				...
				case 'tanker':
					{
						camZoom = 0.9;
						curStage = 'tanker';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stages/tanker'));
						bg.antialiasing = FlxG.save.data.antialiasing;
				...
				case 'clockworks':
					{
						...
						var stageFront:FlxSprite = new FlxSprite(-450, -350).loadGraphic(Paths.image('stages/clockworks'));
